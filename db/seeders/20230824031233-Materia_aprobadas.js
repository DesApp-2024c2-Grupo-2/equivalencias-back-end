...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    const insertarEquivalencium = async (id, nombre) => {
      const resultado = await queryInterface.sequelize.query(
        `SELECT id FROM "Equivalencium" WHERE id = :id`, // Cambié "Equivalencia" por "Equivalencium"
        {
          replacements: { id },
          type: queryInterface.sequelize.QueryTypes.SELECT,
        }
      ...
      if (resultado.length === 0) {
        ...
        await queryInterface.bulkInsert('Equivalencium', [
          // Cambié "Equivalencia" por "Equivalencium"
          {
            id,
            nombre: nombre,
            createdAt: new Date(),
    ...
    try {
      ...
      if (!tablas.some((table) => table.table_name === 'Equivalencium')) {
        // Cambié "Equivalencia" por "Equivalencium"
        throw new Error(
          'La tabla "Equivalencium" no existe en la base de datos.' // Cambié "Equivalencia" por "Equivalencium"
        );
      }

      // Insertar los equivalentes
      const equi1 = await insertarEquivalencium(1, 'Equivalente A'); // Cambié "Equivalencia" por "Equivalencium"
      const equi2 = await insertarEquivalencium(2, 'Equivalente B'); // Cambié "Equivalencia" por "Equivalencium"
      const equi3 = await insertarEquivalencium(3, 'Equivalente C'); // Cambié "Equivalencia" por "Equivalencium"
      const equi4 = await insertarEquivalencium(4, 'Equivalente D'); // Cambié "Equivalencia" por "Equivalencium"
      const equi5 = await insertarEquivalencium(5, 'Equivalente E'); // Cambié "Equivalencia" por "Equivalencium"
      ...
      const registrosParaInsertar = [
        {
          ...
          nombre_materia: 'Gramática I',
          certificado: true,
          EquivalenciumId: equi1, // Cambié "EquivalenciaId" por "EquivalenciumId"
          UniversidadOrigenId: cod1,
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          nombre_materia: 'Programacion 1',
          certificado: true,
          EquivalenciumId: equi2, // Cambié "EquivalenciaId" por "EquivalenciumId"
          UniversidadOrigenId: cod2,
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          nombre_materia: 'Quimica General',
          certificado: false,
          EquivalenciumId: equi3, // Cambié "EquivalenciaId" por "EquivalenciumId"
          UniversidadOrigenId: cod3,
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          nombre_materia: 'Pedagogía I',
          certificado: false,
          EquivalenciumId: equi4, // Cambié "EquivalenciaId" por "EquivalenciumId"
          UniversidadOrigenId: cod4,
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          nombre_materia: 'Programación con Objetos I',
          certificado: true,
          EquivalenciumId: equi5, // Cambié "EquivalenciaId" por "EquivalenciumId"
          UniversidadOrigenId: cod5,
          createdAt: new Date(),
          updatedAt: new Date(),
        },
