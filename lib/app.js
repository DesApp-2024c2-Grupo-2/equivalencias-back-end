...
app.use(
  helmet({
    contentSecurityPolicy: {
      useDefaults: true, // Utiliza las directivas por defecto
      directives: {
        'default-src': ["'self'"], // Solo permite recursos desde el mismo origen
        'script-src': ["'self'", "'unsafe-inline'"], // Permite scripts en línea (poco seguro)
